<template>
    <div class="article_item">
        ...
        <div class="article_item_icon">
            ...
            <svg @click="disableArticle" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#E04F5F" class="w-6 h-6">
        ...
        methods: {
            ...
            async disableArticle() {
                ...
                if (confirm('L\'article "' + this.title + '" sera conservé dans la base de donnée mais n\'apparaitra plus dans l\'espace d\'administration. Voulez-vous poursuivre?')) {
                    ...
                    const { disableArticle }    = useArticle();
                    const response              = await disableArticle(body);
