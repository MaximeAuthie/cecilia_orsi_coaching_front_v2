<script setup>
    ...
    //? Récupérer le numéro de télé^phhone dans les variables d'environnement
            ...
            <ul class="footer_nav_list">
                <li class="footer_nav_list_item">
                    <nuxt-link class="footer_nav_list_item_link" to="https://goo.gl/maps/is1UcE1G4ajw2Rtn9" target="_blank" rel="external">
                        ...
                        <div class="footer_nav_list_item_link_test">
                ...
                <li class="footer_nav_list_item">
                    <nuxt-link class="footer_nav_list_item_link" to="/legalInformations">Mentions légales</nuxt-link>
                </li>
                <li class="footer_nav_list_item">
                    <nuxt-link  class="footer_nav_list_item_link" to="https://www.instagram.com/cecilia_orsi_coaching/" aria-label="Lien vers mon compte Instagram" target="_blank" rel="external">
                        <svg id="instagram_svg" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 448 512">
...
<style scoped>
    ...
    .footer_nav_list_item_link_test {
        padding-top: 1vh;
    }
    .footer_nav_list_item_link:visited {
        color: #FFFFFF;
    }
    .footer_nav_list_item_credit {
