...
export const useUsersStore = defineStore('users', {
    ...
    actions: {
        ...
        //! Appeler la fonction getAllUsers() du composable useUser et stocker le retour dans this.users
        async getAllUsers() {
        ...
        //! Appeler la fonction getRole() du composable useUser et stocker le retour dans this.role et this.firstName
        async getRole() {
            const body = {
                id : this.id
            }
